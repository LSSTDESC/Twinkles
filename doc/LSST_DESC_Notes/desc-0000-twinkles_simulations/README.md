...
## desc-0000-twinkles_simulations
# Static Sky Simulations in Twinkles

*Scott Daniel and others*

A description of the simulations used to generate the static sky in the Twinkles images.
