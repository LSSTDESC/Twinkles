...
* Click File->Download As and choose Microsoft Word (*.docx)
...
* Edit weekly/index.html and add a link to the new document
* git add, commit, push to the Twinkles gh-pages branch
